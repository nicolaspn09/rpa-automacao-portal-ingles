...
def aguarda_elementos_books(navegador, livro):
    pass # Logica de negocio removida por seguranca corporativa
...
if __name__ == "__main__":
    ...
    for i in tabela_base:
        ...
        aguarda_elementos_books(navegador=navegador, livro=livro)
    ...
    # Criar um google sheet para informar quais são as lessons e os livros que serão pesquisados.